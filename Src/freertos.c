...
//
    ...
    osThreadDef(autoTask, auto_task, osPriorityNormal, 0, 256);
    auto_task_handle = osThreadCreate(osThread(autoTask), NULL);

    osThreadDef(detectTask, detect_task,osPriorityHigh,0,128);
